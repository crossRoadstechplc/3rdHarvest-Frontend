// Centralized content from new content.docx
export const siteContent = {
  hero: {
    headline: "Unlocking Multiple Harvests from a Single Coffee Crop",
    subheadline: "3rd Harvest is an origin-led initiative transforming coffee production through women-led entrepreneurship, renewable energy, and circular agriculture.",
    keyLine: "Coffee. Energy. Soil.",
    ctaPrimary: "Explore the Program",
    ctaSecondary: "Partner with 3rd Harvest"
  },
  sections: {
    idea: {
      title: "The Idea",
      subtitle: "A New Model for Coffee Communities",
      description: "Coffee production generates more than just coffee. When integrated into a circular system, it can produce renewable energy, regenerate soils, and create new economic opportunities for women. 3rd Harvest brings these elements together into a single system that enables coffee communities to unlock multiple harvests from the same crop."
    },
    system: {
      title: "The System",
      subtitle: "The 3rd Harvest System",
      description: "At the center of the initiative is the TriveraPro Unit, an integrated technology platform that combines:",
      components: [
        "Solar-powered coffee pulping",
        "Biogas generation from coffee waste",
        "Clean cooking energy for households",
        "Compost production for soil regeneration"
      ],
      cta: "Discover TriveraPro"
    },
    pcw: {
    ...
    impact: {
      ...
      description: "The 3rd Harvest program delivers measurable environmental, social, and economic outcomes. Key metrics tracked through the 3rd Harvest Impact Framework include:",
      metrics: [
      ...
      framework: {
        ...
        indicators: [
          {
            name: "Women entrepreneurs enabled",
            description: "Number of Proud Coffee Women teams operating TriveraPro systems."
          },
          {
            name: "Coffee value created",
            description: "Volume of coffee processed through renewable systems."
          },
          {
            name: "Clean energy generated",
            description: "Households using biogas cooking energy."
          },
          {
            name: "Carbon emissions avoided",
            description: "Estimated CO2 emissions reductions through methane capture and firewood displacement."
          },
          {
            name: "Soil regeneration",
            description: "Volume of compost returned to agricultural soils."
          }
        ],
        certificate: {
    ...
    partners: {
      ...
      subtitle: "Working Together for Regenerative Coffee",
      description: "3rd Harvest operates as a collaborative platform connecting coffee companies, development organizations, philanthropic institutions, and local partners. By aligning development resources with private-sector participation, the initiative enables scalable solutions for coffee communities and supply chains.",
      partnerTypes: [
        "Coffee companies",
    ...
    vision: {
      title: "The Vision",
      subtitle: "A New Harvest for Coffee",
      description: "3rd Harvest aims to expand circular coffee systems across producing regions, creating communities where agricultural waste becomes energy, soils are regenerated, and women entrepreneurs lead the next generation of coffee production."
    }
  },
  footer: {
  ...
  triveraPro: {
    ...
    components: {
      solar: {
        title: "Solar-Powered Coffee Processing",
        description: "Solar energy powers the coffee pulping system, enabling communities to convert coffee cherries into higher-value washed coffee without relying on fossil fuels."
      },
      biogas: {
        title: "Biogas Energy Generation",
        description: "Coffee pulp produced during processing is fed into a biogas digester where natural fermentation generates methane gas. This gas provides clean cooking energy for households in the community."
      },
      cooking: {
        title: "Clean Cooking Solutions",
        description: "The biogas produced through the system replaces traditional firewood and charcoal cooking, reducing indoor air pollution and pressure on local forests."
      },
      compost: {
  ...
  pcwPage: {
    ...
    team: {
      title: "The PCW Team Model",
      description: "Each Proud Coffee Women team consists of three women entrepreneurs who jointly operate a TriveraPro system within their community. Together they manage:",
      responsibilities: [
    ...
    purpose: {
      ...
      description: "Coffee produced through the PCW system represents more than a product. It reflects a production model where:",
      values: [
